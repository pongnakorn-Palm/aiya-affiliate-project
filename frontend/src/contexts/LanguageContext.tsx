...
const translations: Record<Language, Record<string, string>> = {
  th: {
    ...
    "dashboard.referralCode": "รหัสแนะนำของคุณ",
    "dashboard.shareCode": "แชร์รหัส",
    "dashboard.sharing": "กำลังแชร์...",
    "dashboard.activity": "กิจกรรมล่าสุด",
    "dashboard.registrations": "ผู้สมัครใหม่",
    "dashboard.weekly": "7 วันที่ผ่านมา",
    ...
    "profile.partnerId": "รหัสพาร์ทเนอร์",
  ...
  en: {
    ...
    "dashboard.registrations": "New Registrations",
    "dashboard.weekly": "Last 7 Days",
